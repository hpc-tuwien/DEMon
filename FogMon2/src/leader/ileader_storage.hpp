...
public:
    ...
    virtual Report::report_result getReport(Message::node node, bool complete) = 0;
    ...
    virtual std::vector<Report::report_result> getReport(bool complete = false) = 0;
    ...
    virtual std::vector<Report::test_result> getLatency(Message::node node, bool complete) = 0;
    virtual std::vector<Report::test_result> getBandwidth(Message::node node, bool complete) = 0;

    virtual std::vector<Message::node> removeOldLNodes(int seconds, int &leaders_num, bool force=false) = 0;
    ...
    //Changed from J 
    virtual void addGossipMsg(const std::string& sender, const std::string& receiver) = 0;
